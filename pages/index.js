      ...
      <section className="mt-[122px] mb-[50px] lg:mb-[212px]">
        <div className="wrapper flex gap-[20px] lg:gap-[97px] items-center justify-between flex-col lg:flex-row  ">
          <div className="text-center lg:text-left">
            ...
            <p className="text1 text-black-400 mb-[20px] px-[20px] lg:py-0">
            ...
            <p className="text1 text-black-400 px-[20px] lg:py-0">
      ...
      <section className="mb-[162px]" id="praktikum">
        <div className="wrapper">
          ...
          <div className="flex justify-between flex-col lg:flex-row gap-[37px] lg:gap-[40px]">
            <Link href="/ski">
              <button className="lg:subhead1 lg:py-[26px] lg:px-[144px] text-white bg-ski-btn rounded-[20px] shadow-xl py-[19px] px-[85px] subhead4 mx-[20px] lg:mx-0">
                <p className="lg:mb-2.5 mb-0">Sistem Kontrol</p>
                <p>Industri</p>
              </button>
            </Link>
            <Link href="/ski">
              <button className="lg:subhead1 lg:py-[26px] lg:px-[144px] text-white bg-siskon-btn rounded-[20px] shadow-xl py-[32px] px-[85px] subhead4 mx-[20px] lg:mx-0">
                <p>Sistem Kontrol</p>
              </button>
            </Link>
          </div>
